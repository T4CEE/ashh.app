    ...
    <View>
      ...
      <View style={{
        ...
        <View style={styles.FlexCon}>
          <View>
            <ImageBackground source={require('@/assets/images/clothing.jpg')} resizeMode="cover" style={[styles.image, { justifyContent: 'flex-end', height: 480, width: win.width }]}>
            <Text style={[styles.text, {color: 'black'}]}>PARIS</Text>
            <Text style={{fontSize:18, color: 'black', marginBottom: 60,  paddingHorizontal: 9,}}>PARIS FASHION WEEK</Text>
        ...
        <View style={styles.FlexCon}>
          ...
          <View>
            <ImageBackground source={require('@/assets/images/sports image.jpeg')} resizeMode="cover" style={[styles.image, { justifyContent: 'flex-end', height: 480, width: win.width }]}>
            <Text style={styles.text}>DELILAH X</Text>
            <Text style={{fontSize:18, color: 'white', marginBottom: 60,  paddingHorizontal: 9,}}>HASH x PREMIUM</Text>
              <TouchableOpacity onPress={() => navigation.navigate('SummerScreen')} style={{ backgroundColor: '#353839', alignItems: "flex-end", paddingHorizontal: 12, paddingVertical: 22, }}>
                <Text style={{ color: "white", fontWeight: 'bold' }}>SHOP NOW</Text>
              </TouchableOpacity>
            </ImageBackground>
